const foodOriginalData = [
  ...
  //by using the for loop the data will be displayed
  ...
  getalldairydata();
  function getallcaloriedatagreaterthan100() {
    for (i = 0; i < foodOriginalData.length; i++) {
  ...
  getallcaloriedatagreaterthan100();
  function getallcaloriedatalessthan100() {
    for (i = 0; i < foodOriginalData.length; i++) {
      const calorie = foodOriginalData[i].calorie;
      if (calorie < "100") {
        console.log(foodOriginalData[i]);
  ...
  getallcaloriedatalessthan100();
  
  foodOriginalData.sort((a, b) => b.protein - a.protein);
  
  for (let i = 0; i < foodOriginalData.length; i++) {
    console.log(foodOriginalData[i]);
  }
  
  foodOriginalData.sort((a, b) => a.cab - b.cab);
  
  for (let i = 0; i < foodOriginalData.length; i++) {
    console.log(foodOriginalData[i]);
  }
  
  //by using the map the data will be displayed
  
  foodOriginalData.map((data) => {
    console.log(data);
  });
  ...
  foodOriginalData.sort((a, b) => b.protiens - a.protiens);
  {
